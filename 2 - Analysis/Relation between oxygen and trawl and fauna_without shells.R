...
# check relationships between oxygen/trawling and total faunal biomass and abundance
...
#  pdf(paste(getwd(),"3 - Outputs/Oxygen_biomass_abundance_shellfree.pdf",sep="/"),width=7,height=6) 
